...
## Descripton
This SAP HANA Cloud (HC) demo content application will enable you to experience hands-on how the powerful vector engine in SAP HANA Cloud transforms simple queries into detailed, context-aware responses. The content package contains everything you need to build your own movie insights app. 
 ...
 * The Table and Service is names "Movie", although it also contains doucmentaries
